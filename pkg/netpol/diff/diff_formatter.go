...
func getDirsConnsStrings(c SrcDstDiff) (ref1Str, ref2Str string) {
	...
	case ChangedType, UnchangedType:
		return common.ConnStrFromConnProperties(ref1AllowedConns.AllConnections(), ref1AllowedConns.ProtocolsAndPortsMap()),
			common.ConnStrFromConnProperties(ref2AllowedConns.AllConnections(), ref2AllowedConns.ProtocolsAndPortsMap())
	case AddedType:
		return noConns, common.ConnStrFromConnProperties(ref2AllowedConns.AllConnections(), ref2AllowedConns.ProtocolsAndPortsMap())
	case RemovedType:
		return common.ConnStrFromConnProperties(ref1AllowedConns.AllConnections(), ref1AllowedConns.ProtocolsAndPortsMap()), noConns
	default:

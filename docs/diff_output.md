...
digraph {
        subgraph cluster_default {
                "backend[Deployment]" [label="backend[Deployment]" color="blue" fontcolor="blue"]
        ...
        "0.0.0.0-255.255.255.255" -> "backend[Deployment]" [label="TCP 9090" color="#008000" fontcolor="#008000"]        
        "0.0.0.0-255.255.255.255" -> "frontend[Deployment]" [label="TCP 8080" color="grey" fontcolor="grey"]
        "frontend[Deployment]" -> "0.0.0.0-255.255.255.255" [label="UDP 53" color="grey" fontcolor="grey"]
        "frontend[Deployment]" -> "backend[Deployment]" [label="TCP 9090,UDP 53 (dir1: TCP 9090)" color="magenta" fontcolor="magenta"]
}
```

...
| {ingress-nginx} | helloworld/hello-world[Deployment] | TCP 8000 |
| {ingress-nginx} | ingressworld/ingress-world[Deployment] | TCP 8090 |
| {ingress-nginx} | routeworld/route-world[Deployment] | TCP 8060 |
| {openshift-ingress-operator} | helloworld/hello-world[Deployment] | TCP 8000 |
| {openshift-ingress-operator} | ingressworld/ingress-world[Deployment] | TCP 8090 |
| {openshift-ingress-operator} | routeworld/route-world[Deployment] | TCP 8060 |